const func = () => {
    ...
    let tAverage = avg1 + avg2 + avg3 + avg4;
    ...
    if (finalDL<1 && g1<=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
    ...
    else if (finalPL>=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
    ...
    else if (finalDL<=2.4 && finalPL<1 && g1<=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
    ...
    else if (finalPL<1 && finalDL>2.4 && g1<=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
    ...
    else if (finalDL<2.4 && finalPL<2.4 && g1<=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
    ...
    else if (finalPL<2.4 && finalDL>=2.4 && g1<=2.4 && g1>=1 && g2<=2.4 && g2>=1 && g3<=2.4 && g3>=1 && g4<=2.4 && g4>=1 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
    ...
    else if (g1>=1 && g1<5 && g2>=1 && g2<5 && g3>=1 && g3<5 && g4>=1 && g4<5 && u1>0 && u2>0 && u3>0 && u4>0 && remaining>=1){
        document.getElementById('showData-1').innerHTML = `<strong style="color:yellow;"> CURRENT GWA </strong>`
        document.getElementById('showData-2').innerHTML = "";
        document.getElementById('showData-3').innerHTML = gwa;
        document.getElementById('showData-4').innerHTML = `<strong style="color:yellow;"> President Lister Goal </strong>`
